...
function openCheckout(p){syncProductSelects(p.id);document.getElementById('payName').innerText=p.name;document.getElementById('payPrice').innerText=p.priceText;document.getElementById('payNote').innerText=p.name;document.getElementById('payQr').src=qrUrl(p);document.getElementById('paidNotice').style.display='none';document.getElementById('checkout').style.display='flex'}
function closeCheckout(){document.getElementById('checkout').style.display='none'}
function showPaidNotice(){document.getElementById('paidNotice').style.display='block';setTimeout(()=>{closeCheckout();document.getElementById('license')?.scrollIntoView({behavior:'smooth'})},900)}
