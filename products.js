/* =====================================================
   PHƯƠNG G63 ENTERPRISE - PRODUCTS.JS
...
const PRODUCTS = [
  ...
  },
  {
    ...
    description:'Sản phẩm đang được chuẩn bị nội dung, hình ảnh và tính năng chi tiết.', features:['Trang sản phẩm riêng','Ảnh giới thiệu riêng','Nút thanh toán QR riêng','Hướng dẫn cài đặt riêng'], install:['Đang cập nhật'], faq:[['Khi nào ra mắt?','Bố gửi code, ảnh và giá, con sẽ đưa lên website.']], videoTitle:'Coming soon', videoText:'Đang cập nhật.'
  }
];

const UPDATES = [
  {version:'V15 Enterprise', date:'Hiện tại', text:'Thêm tìm kiếm, bộ lọc, so sánh sản phẩm, Academy, Patch Notes, Customer Center và hệ thống thêm EA dễ mở rộng.'},
